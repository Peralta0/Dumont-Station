...
public sealed class XenobiologyConsoleSystem : EntitySystem
{
    ...
    [Dependency] private readonly SlimeGrinderSystem _slimeGrinder = default!;
    [Dependency] private readonly SurveillanceCameraSystem _surveillanceCamera = default!;
    [Dependency] private readonly TagSystem _tag = default!;
    [Dependency] private readonly SharedTransformSystem _transform = default!;
    [Dependency] private readonly SharedConsoleCameraSystem _cameraVision = default!;
    ...
    private void OnShortcutRequest(XenobiologyConsoleShortcutRequest request, EntitySessionEventArgs args)
    {
        ...
        if (!EntityManager.TryGetEntity(request.Coordinates.NetEntity, out var coordinateEntity))
            return;
        ...
        if (request.Target is { } netTarget &&
            EntityManager.TryGetEntity(netTarget, out var entity) &&
